...
`AUTH_FAILED` · `AUTHZ_DENIED` · `POLICY_DENIED` · `RESOURCE_NOT_FOUND` · `AMBIGUOUS_TARGET` · `UPSTREAM_TIMEOUT` · `UPSTREAM_UNAVAILABLE` · `UPSTREAM_RATE_LIMITED` · `SCHEMA_VALIDATION_FAILED` · `MODEL_UNAVAILABLE` · `MODEL_OUTPUT_INVALID` · `BUDGET_EXHAUSTED` · `SERVICE_DISABLED` · `INTERNAL_ERROR`
